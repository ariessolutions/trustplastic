                                                ...
                                                <div class="col-xl-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select class="form-select" id="usertype" name="usertype">
                                                            ...
                                                            <option {{ (old('usertype')==$ut->id)?'selected':'' }}
                                                                value="{{ $ut->id }}">{{ $ut->usertype }}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-xl-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="firstname" name="firstname"
                                                            value="{{ old('firstname') }}" type="text"
                                                            class="form-control fs-15px" placeholder="e.g John" />
                                                        @error('firstname')
                                                        <span class="text-danger">
                                                            <small>{{ $message }}</small>
                                                        </span>
                                                ...
                                                <div class="col-xl-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="lastname" name="lastname"
                                                            ...
                                                            class="form-control fs-15px" placeholder="e.g Smith" />
                                                        @error('lastname')
                                                        <span class="text-danger">
                                                            <small>{{ $message }}</small>
                                                        </span>
                                                ...
                                                <div class="col-xl-3">
                                                    <div class="mb-3">
                                                        <label class="form-label">Emp Number <span
                                                                class="text-danger">*</span></label>
                                                        <input name="emp_number" id="emp_number"
                                                            value="{{ old('emp_number') }}" type="text"
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="email" name="email" value="{{ old('email') }}" type="text"
                                                            class="form-control fs-15px" placeholder="username@address.com" />
                                                        @error('email')
                                                        <span class="text-danger">
                                                            <small>{{ $message }}</small>
                                                        </span>
